...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48O'),
        ('backend/api/api_server.py', "'stage': '48O'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48O'"),
        ('backend/telegram/response_format.py', 'AstraEdge 48O'),
    ):
