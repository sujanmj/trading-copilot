#!/usr/bin/env python3
"""stage 51V — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51V' or ASTRAEDGE_BUILD_STAGE != '51V':
        return _fail(f'expected build stage 51V got {stage!r}')
