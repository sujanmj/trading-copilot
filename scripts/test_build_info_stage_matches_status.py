#!/usr/bin/env python3
"""Stage 51M — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51M' or ASTRAEDGE_BUILD_STAGE != '51M':
        return _fail(f'expected build stage 51M got {stage!r}')
