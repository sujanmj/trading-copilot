...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48K'),
        ('backend/api/api_server.py', "'stage': '48K'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48K'"),
        ('backend/telegram/response_format.py', 'AstraEdge 48K'),
    ):
