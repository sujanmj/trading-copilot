...
def _validate_changed_file_scope() -> str | None:
    ...
    forbidden_hits = ((tracked_changed | relevant_untracked) & FORBIDDEN_PRODUCTION) - ALLOWED_SUCCESSOR_B2 - ALLOWED_SUCCESSOR_C1B - ALLOWED_SUCCESSOR_D - ALLOWED_SUCCESSOR_D2P
    if forbidden_hits:
