#!/usr/bin/env python3
"""Stage 51H — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51H' or ASTRAEDGE_BUILD_STAGE != '51H':
        return _fail(f'expected build stage 51H got {stage!r}')
