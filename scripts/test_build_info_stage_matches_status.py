#!/usr/bin/env python3
"""stage 51O — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51O' or ASTRAEDGE_BUILD_STAGE != '51O':
        return _fail(f'expected build stage 51O got {stage!r}')
