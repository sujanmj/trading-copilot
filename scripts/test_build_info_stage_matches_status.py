#!/usr/bin/env python3
"""stage 51Q — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51Q' or ASTRAEDGE_BUILD_STAGE != '51Q':
        return _fail(f'expected build stage 51Q got {stage!r}')
