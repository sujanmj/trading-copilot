...
def format_tradecard_memory_stats_telegram() -> str:
    ...
    lines = [
        ...
        f'skipped_watch_only_today: {stats.get("skipped_watch_only_today") or 0}',
        f'skipped_stale_scanner_today: {stats.get("skipped_stale_scanner_today") or 0}',
        f'skipped_below_threshold_today: {stats.get("skipped_below_threshold_today") or 0}',
