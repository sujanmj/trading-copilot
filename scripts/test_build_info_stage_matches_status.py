#!/usr/bin/env python3
"""stage 51W — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '52I-A' or ASTRAEDGE_BUILD_STAGE != '52I-A':
        return _fail(f'expected build stage 52I-A got {stage!r}')
