#!/usr/bin/env python3
"""Stage 51N — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51N' or ASTRAEDGE_BUILD_STAGE != '51N':
        return _fail(f'expected build stage 51N got {stage!r}')
