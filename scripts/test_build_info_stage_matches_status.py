#!/usr/bin/env python3
"""Stage 51J — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51J' or ASTRAEDGE_BUILD_STAGE != '51J':
        return _fail(f'expected build stage 51J got {stage!r}')
