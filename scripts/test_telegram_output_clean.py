#!/usr/bin/env python3
"""
Dry-run simulation for clean Telegram output (Stage 50L hotfix).
...
def main() -> int:
    ...
    if ASTRAEDGE_TELEGRAM_BUILD != 'AstraEdge 50L':
        return _fail(f'expected AstraEdge 50L got {ASTRAEDGE_TELEGRAM_BUILD!r}')
