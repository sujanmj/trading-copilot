#!/usr/bin/env python3
"""stage 51R — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51R' or ASTRAEDGE_BUILD_STAGE != '51R':
        return _fail(f'expected build stage 51R got {stage!r}')
