#!/usr/bin/env python3
"""stage 51P — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51P' or ASTRAEDGE_BUILD_STAGE != '51P':
        return _fail(f'expected build stage 51P got {stage!r}')
