#!/usr/bin/env python3
"""Stage 51F — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51F' or ASTRAEDGE_BUILD_STAGE != '51F':
        return _fail(f'expected build stage 51F got {stage!r}')
