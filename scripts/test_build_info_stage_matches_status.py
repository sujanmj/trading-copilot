#!/usr/bin/env python3
"""Stage 51G — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51G' or ASTRAEDGE_BUILD_STAGE != '51G':
        return _fail(f'expected build stage 51G got {stage!r}')
