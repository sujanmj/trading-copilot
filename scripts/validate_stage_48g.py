...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48M'),
        ('backend/api/api_server.py', "'stage': '48M'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48M'"),
        ('backend/telegram/response_format.py', 'AstraEdge 48M'),
    ):
