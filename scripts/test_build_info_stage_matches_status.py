#!/usr/bin/env python3
"""Stage 51B — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51B' or ASTRAEDGE_BUILD_STAGE != '51B':
        return _fail(f'expected build stage 51B got {stage!r}')
