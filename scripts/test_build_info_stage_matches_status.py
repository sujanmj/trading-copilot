#!/usr/bin/env python3
"""Stage 51D — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51D' or ASTRAEDGE_BUILD_STAGE != '51D':
        return _fail(f'expected build stage 51D got {stage!r}')
