...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48G'),
        ('backend/api/api_server.py', "'stage': '48G'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48G'"),
        ('backend/telegram/response_format.py', 'AstraEdge 48G'),
    ):
