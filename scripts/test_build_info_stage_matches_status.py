#!/usr/bin/env python3
"""stage 51S — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51S' or ASTRAEDGE_BUILD_STAGE != '51S':
        return _fail(f'expected build stage 51S got {stage!r}')
