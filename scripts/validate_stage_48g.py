...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48N'),
        ('backend/api/api_server.py', "'stage': '48N'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48N'"),
        ('backend/telegram/response_format.py', 'AstraEdge 48N'),
    ):
