...
def send_message(
    ...
    *,
    ...
    if not guard_telegram_send('telegram_listener.send_message'):
        return True
...
def get_updates(offset=0):
    ...
    if not guard_telegram_poll('telegram_listener.get_updates'):
        return []
...
def listen_forever():
    ...
    if not is_telegram_listener_enabled():
        safe_print('[TELEGRAM DISABLED] listener not started')
        return
