...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48Q'),
        ('backend/api/api_server.py', "'stage': '48Q'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48Q'"),
        ('backend/analytics/broker_intelligence.py', "STAGE = '48Q'"),
    ):
