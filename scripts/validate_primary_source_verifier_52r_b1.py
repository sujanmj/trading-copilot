...
ALLOWED_CHANGED_SOURCE = (
    INTENDED_PRODUCTION | ALLOWED_HISTORICAL_REGRESSIONS | ALLOWED_B1_TESTS | ALLOWED_SUCCESSOR_B2N | ALLOWED_SUCCESSOR_B2 | ALLOWED_SUCCESSOR_C1A | ALLOWED_SUCCESSOR_C1B | ALLOWED_SUCCESSOR_D | ALLOWED_SUCCESSOR_D2P | ALLOWED_SUCCESSOR_D2 | ALLOWED_SUCCESSOR_53A | ALLOWED_SUCCESSOR_53A2
)
...
def _validate_changed_file_scope() -> str | None:
    ...
    forbidden_hits = ((tracked_changed | relevant_untracked) & FORBIDDEN_PRODUCTION) - ALLOWED_SUCCESSOR_B2N - ALLOWED_SUCCESSOR_B2 - ALLOWED_SUCCESSOR_C1B - ALLOWED_SUCCESSOR_D - ALLOWED_SUCCESSOR_D2P
    if forbidden_hits:
...
def main() -> int:
    ...
    if (BUILD_STAGE, TELEGRAM_BUILD) not in allowed:
        return _fail(
            f'build must be exact 52R-B1 pair or successor 52R-B2N/52R-B2/52R-C1A/52R-C1B/52R-D pair, '
