...
def test_exact_build_pair_allowlists() -> int:
    ...
    if ('52R-D2P', 'AstraEdge 52R-D2P') not in daily_pairs:
        return _fail('D2P successor pair missing from daily-review allowlist')
    if ('52R-D2P', 'AstraEdge 52R-D2P') not in tradecard_pairs:
        return _fail('D2P successor pair missing from tradecard allowlist')
    if ('52R-D2', 'AstraEdge 52R-D2') not in daily_pairs:
    ...
    if ('53A2', 'AstraEdge 53A2') not in daily_pairs:
        return _fail('53A2 successor pair missing from daily-review allowlist')
    if ('53A2', 'AstraEdge 53A2') not in tradecard_pairs:
        return _fail('53A2 successor pair missing from tradecard allowlist')
    mismatches = (
