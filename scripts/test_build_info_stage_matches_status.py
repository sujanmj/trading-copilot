#!/usr/bin/env python3
"""Stage 51I — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51I' or ASTRAEDGE_BUILD_STAGE != '51I':
        return _fail(f'expected build stage 51I got {stage!r}')
