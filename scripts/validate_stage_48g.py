...
def main() -> int:
    for rel, needle in (
        ('backend/config/local_safe_mode.py', 'AstraEdge 48S'),
        ('backend/api/api_server.py', "'stage': '48S'"),
        ('backend/analytics/budget_impact.py', "STAGE = '48S'"),
        ('backend/analytics/broker_intelligence.py', "STAGE = '48S'"),
    ):
