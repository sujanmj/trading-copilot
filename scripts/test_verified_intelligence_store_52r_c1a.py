...
def test_build_identity() -> int:
    ...
    allowed = {('52R-C1A', 'AstraEdge 52R-C1A'), ('52R-C1B', 'AstraEdge 52R-C1B'), ('52R-D', 'AstraEdge 52R-D')}
    mismatches = (
...
def test_safety_boundaries() -> int:
    ...
    if _stage in {'52R-C1B', '52R-D'} and set(caller_hits) != authorized:
