#!/usr/bin/env python3
"""Stage 51C — build-info stage matches canonical /status Telegram build."""
...
def main() -> int:
    ...
    if stage != '51C' or ASTRAEDGE_BUILD_STAGE != '51C':
        return _fail(f'expected build stage 51C got {stage!r}')
